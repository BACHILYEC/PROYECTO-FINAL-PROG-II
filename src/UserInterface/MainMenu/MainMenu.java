...
public class MainMenu {
    public static void gameMenu() {
        ...
        Color tittleColorPanel = new Color(27, 60, 83);
        Color iconColorPanel = new Color(35, 76, 106);
        Color playColorPanel = new Color(69, 104, 130);
        Color secondColorPanel = new Color(200, 227, 227);
        Color colorplayButton = new Color(255, 48, 48);
        Color colorsecondButton = new Color(27, 60, 83);
        ...
        Image iconGame = icon.getImage().getScaledInstance(300, 300, Image.SCALE_SMOOTH);
